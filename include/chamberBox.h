...
class chamberBox : public Detector, public G4VSensitiveDetector {

  public:

  chamberBox(const G4String&, G4double x, G4double y, G4double z,G4double rot, G4double xysize,G4double zsize, G4double thickness,G4LogicalVolume *top);
    virtual ~chamberBox() {}
